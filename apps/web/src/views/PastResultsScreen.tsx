...
export const PastResultsScreen = () => {
  ...
  const pastSessionHistory = useQuizStore((state) => state.pastSessionHistory)
    ...
    <ScreenShell className="justify-center">
      <div className="mx-auto grid w-full max-w-5xl gap-4">
        <Panel className="p-6 sm:p-8">
          ...
          <p className="mt-4 text-3xl font-semibold leading-none text-[#1f2f44] sm:text-4xl">
            {section.hanzi}
          </p>
          <p className="mt-2 text-[11px] uppercase tracking-[0.28em] text-[#5b6f84]">
            {section.label}
          </p>

          <div className="mt-4 grid gap-px border border-[#30455f] bg-[#30455f] sm:grid-cols-2">
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            <ActionButton onClick={startPastSession}>
        ...
        <Panel className="p-4 sm:p-5 lg:p-6">
          ...
          <div className="mt-4 grid gap-px border border-[#30455f] bg-[#30455f]">
            {pastSessionHistory.map((result, index) => {
              return (
                <div
                ...
                >
                  <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                    <div className="min-w-0">
                      <p className="text-sm leading-6 text-[#3e352c]">
                        {result.prompt}
                      </p>
                      <div className="mt-2 flex flex-wrap items-center gap-2">
                        ...
                        {result.correctBopomofo ? (
                          <p className="text-sm tracking-[0.12em] text-[#1f2f44]">
                            {result.correctBopomofo}
                          </p>
                        ) : null}
                        <p className="text-[11px] uppercase tracking-[0.18em] text-[#8c2f22]">
